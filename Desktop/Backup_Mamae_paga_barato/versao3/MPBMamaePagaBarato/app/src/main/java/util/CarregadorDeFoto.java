...
/**
 * Created by ddark on 16/07/17.
 */

public class CarregadorDeFoto {

    /**
     * Metodo que ajusta a imagem para uma resolucao menor. indicada para dispositivos com baixa resolucao e dimensao.
     *
     * obs: Esse metodo nao trata rotacionar a imagem para dispositivos SAngung e Sony. Para isso deve-se usar o outro metodo desse classe
     *
     * @param context
     * @param bmpOriginal
     * @param newWidth

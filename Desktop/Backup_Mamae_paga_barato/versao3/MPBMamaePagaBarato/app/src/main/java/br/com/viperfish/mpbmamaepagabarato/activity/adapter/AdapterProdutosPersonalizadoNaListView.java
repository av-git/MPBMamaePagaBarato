...
public class AdapterProdutosPersonalizadoNaListView extends BaseAdapter {

    private final List<Produto> produtos;
    private final Activity activity;

    public AdapterProdutosPersonalizadoNaListView(List<Produto> produtos, Activity activity) {
    ...
    public View getView(int posicao, View convertView, ViewGroup layoutPai) {
        ...
        //populando as Views
        produtoHolder.titulo.setText(produto.getNome());
        produtoHolder.descricao.setText(produto.getNome());
